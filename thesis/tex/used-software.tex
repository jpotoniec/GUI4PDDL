...
\JP{Skoro wcześniej przykłady były opakowane w ramki i miały swoje numery to tutaj też musi być w ten sposób. Co więcej, skoro jest taki przykład XMLa to musi on być skrótowo chociaż opisany.}
...
ANTLR został opublikowany wraz z kodem źródłowym na licencji BSD. 
Projekt jest
...
%Żaden, w tekstach techniczno-naukowych to wprost porządane. - JP
\begin{itemize}
...
(ang \emph{tree parser})\JP{Skoro to jest tree parser to dlaczego tego nie tłumaczyć jako analizator drzew? Z opisu na http://www.antlr2.org/doc/sor.html wynika mi, że on właśnie analizuje drzewa, a nie używa drzew do analizy czegoś innego?}. Jest to podprogram generowany przez
