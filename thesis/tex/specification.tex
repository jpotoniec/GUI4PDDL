...
\subsubsection{Wspomaganie użytkownika w pracy z edytorem}
\vspace{\fill}
\pagebreak[0]
\vspace{-\fill}
\label{UCeditor}
...
Wtyczka \texttt{GUI4PDDL} umożliwia użytkownikowi efektywne zarządzanie kodem pisanym w języku \texttt{PDDL}. Pomaga w kontrolowaniu zawartości kodu. Wtyczka zbudowana jest jako jeden produkt, zgodnie ze specyfikacją wymaganą przez wtyczki programu \emph{Eclipse}. Zgodnie z polityką twórców Eclipse, \texttt{GUI4PDDL} jest zbudowana w pełni modułowo, co umożliwia pełną integrację ze środowiskiem oraz jest łatwa w rozwoju.
